...
WHERE flaging = 1; -- Deduplicate to keep latest record per customer
...
SELECT
    ...
    -- Derive end date based on next start date
...
SELECT
    ...
    END,
    -- Validate and fix sales amount if incorrect
